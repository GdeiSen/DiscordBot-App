...
var _require2 = require("./songMaster.js"),
    songMaster = _require2.songMaster;

var _require3 = require("discord.js"),
    MessageEmbed = _require3.MessageEmbed;

var _require4 = require('./player'),
...
module.exports.run = function _callee(client, message, args) {
  var QueueMaster, SongMaster, queue, Player;
      ...
      switch (_context.prev = _context.next) {
        case 0:
          try {
            ...
            SongMaster = new songMaster(client, message);
            SongMaster.addListener('INFO', function (info) {
              console.log(info);
            });
            SongMaster.addListener('ERROR', function (error) {
              console.log(error);
              var embed = embedGenerator.run('music.play.error_05');
            ...
            SongMaster.selector(args);
            SongMaster.addListener('SONG_LOADING_DONE', function () {
              Player.start();
            });

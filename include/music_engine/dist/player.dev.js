...
function (_EventEmitter) {
  ...
  _createClass(player, [{
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.next = 3;
                            return regeneratorRuntime.awrap(_this2.emit('INFO', '[INFO] [PL] audioPlayer constructor activated!'));

                          case 3:
                            _context.next = 5;
                            return regeneratorRuntime.awrap(_this2.createPlayer());

                          case 5:
                            _context.next = 7;
                            return regeneratorRuntime.awrap(_this2.createStream(_this2.queue.songs[0].url));

                          case 7:
                            _context.next = 9;
                            return regeneratorRuntime.awrap(_this2.createResource());

                          case 9:
                            _context.next = 11;
                            return regeneratorRuntime.awrap(_this2.play());

                          case 11:
                            _context.next = 13;
                            return regeneratorRuntime.awrap(_this2.pushConnectionAndPlayerToQueue());

                          case 13:
                            _context.next = 15;
                            return regeneratorRuntime.awrap(_this2.queueSongsChanger());

                          case 15:
                            _context.next = 17;
                            return regeneratorRuntime.awrap(_this2.emit('LOADING_DONE'));
              ...
              promise = new Promise(function (resolve, reject) {
                ...
                connection.on('stateChange', function (oldState, newState) {
                  ...
                  if (newState.status == 'ready') {
                    _this3.connection = connection, resolve(newState.status);
    ...
    key: "pushQueue",
    value: function pushQueue() {
      this.message.client.queue = this.queue;
    }
  }, {
    key: "getQueue",
    value: function getQueue() {
      this.queue = this.message.client.queue;
    }
  }, {
